    ...
    <div className="theory-content">
      ...
      <div className="theory-toc">
        ...
        <ul>
          ...
          <li>
            <a href="#mobile-first">Mobile-first Strategy</a>
          </li>
          <li>
            <a href="#breakpoints">Choosing Breakpoints</a>
          </li>
          <li>
      ...
      <div className="theory-body">
        <section id="goal">
          ...
          <p>
            ...
            units like <code>clamp()</code>, <code>vw</code>, and{" "}
            <code>rem</code>.
          </p>
        </section>
        ...
        <section id="concepts">
          ...
          <ul>
            <li>
              <strong>@media</strong> — apply CSS conditionally (width,
              orientation, resolution).
            </li>
            <li>
              <strong>Mobile-first</strong> — base styles target small screens;
              use <code>min-width</code> to progressively enhance.
            </li>
            <li>
              <strong>Fluid units</strong> — combine <code>vw</code> and{" "}
              <code>clamp()</code> to avoid abrupt jumps.
            </li>
            <li>
              <strong>Container vs viewport queries</strong> — container queries
              target component size (modern), media queries target viewport
              size.
            </li>
          </ul>
        </section>
        ...
        <section id="mobile-first">
          ...
          <p>
            Start with the smallest screen as the default. Then write rules for
            larger screens using <code>@media (min-width: ...)</code>. This
            keeps CSS small and improves the cascade when styles layer on top of
            each other.
          </p>
          <pre>
            {`/* Mobile-first */
...
@media (min-width: 768px) {
  .card { padding: 20px; display: grid; grid-template-columns: 1fr 2fr; }
        ...
        <section id="breakpoints">
          ...
          <p>
            Avoid device-specific breakpoints. Prefer content-driven breakpoints
            where the layout actually needs to change. Typical starting points
            are 480px, 768px, and 1024px — but use what your design requires.
          </p>
          <ul>
            <li>
              Use <code>min-width</code> for a mobile-first approach.
            </li>
...
@media (min-width: 768px) {
  .grid { grid-template-columns: repeat(2, 1fr); }
          ...
          <pre>{`.headline { font-size: clamp(1rem, 2.4vw, 1.25rem); }`}</pre>

          <h3>3) Responsive navigation pattern</h3>
          <p>
            Hide full menu on small screens and show a hamburger. On larger
            screens, display menu horizontally.
          </p>
          <pre>
...
@media (min-width: 768px) {
  .nav-links { display: flex; gap: 16px; }
        ...
        <section id="pro-tips">
          ...
          <ul>
            <li>
              Design fluidly between breakpoints — avoid too many sharp jumps.
            </li>
            <li>
              Prefer content-driven breakpoints over device-specific ones.
            </li>
            <li>
              Use <code>clamp()</code> for font-size and spacing that scales
              smoothly.
            </li>
            <li>
              Consider CSS custom properties to centralize breakpoint values.
            </li>
          </ul>
        </section>
        ...
        <section id="accessibility">
          ...
          <p>
            Keep responsive interactions accessible: ensure navigation can be
            used with keyboard, prefer reduced-motion support for animations,
            and lazy-load large images where appropriate. Minimizing heavy
            layout thrashing improves perceived performance.
          </p>
          <ul>
            <li>
            ...
            <li>
              Responsive images: use <code>srcset</code> and{" "}
              <code>&lt;picture&gt;</code> to serve appropriate sizes.
            </li>
            <li>
              Use hardware-friendly properties (transform, opacity) for
              animations.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            <code>768px</code>. Start mobile-first and use the examples above as
            a reference.
          </p>
        </section>
      </div>
